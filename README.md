...
## Design Rationale
  ...
  * Reader never crashes, throw unexpected exceptions or gets stuck when reading files even if those files were specially crafted by malicious actors with access to the reader's source code.
